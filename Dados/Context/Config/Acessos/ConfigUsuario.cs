    ...
    {      
        ...
        internal static void Config(ModelBuilder model)
        {
            model.Entity<Usuario>(t =>
            {
                ...
                t.Property(p => p.Id).UseOracleIdentityColumn().HasColumnName("CD_SEQ_USUARIO");
                ...
                t.Property(p => p.IsAtivo).HasColumnName("ST_ATIVO").HasDefaultValue(false);
                t.Property(p => p.IsTraderComb)                    
                        .HasColumnName("DS_TRADER_COMBUSTIVEL")
                        .HasDefaultValue(false);
                t.Property(p => p.IsTraderEAB)                        
